...
myApp.service("kulfyService",function($http,$q,$location,$cookies,$routeParams){
    ...
    if(kulfy_id){
        ...
        var url = "https://api.kulfyapp.com/gifs/getDashboard?skip=0&limit=30&language=telugu";
        $http.get(url).success(function(data){
...
myApp.controller('KulfyController', function($scope,$location,$cookies,$rootScope, Reddit,kulfyService) {
